...
public class BlogPostController {
    ...
    public String updateExistingPost(@PathVariable Long id, BlogPost blogPost, Model model) {
        ...
        if (post.isPresent()) {
            ...
            // It wouldn't display the updated post on the results page if I'd gotten there from the edit page, so I did the below attributes separately and that seemed to work.
